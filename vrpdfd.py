...
arr = [
    (
        (
            (frozenset({0, 1, 2, 3, 4, 5, 8, 9, 10, 13, 14, 16, 18, 20}),),
            (
                (
                    frozenset({0, 12}),
                    frozenset({0, 16}),
        ...
        VRPDFDIndividual(
            solution_cls=VRPDFDSolution,
            truck_paths=(frozenset({0, 1, 2, 3, 5, 8, 9, 10, 12, 13, 14, 15, 16, 20}),),
            drone_paths=((),),
        ),
    ),
    (
    ...
    (
        (
            (frozenset({0, 1, 2, 3, 5, 8, 9, 10, 12, 13, 14, 15, 16, 18, 20}),),
            (
                (
                    frozenset({0, 13}),
                    frozenset({0, 13}),
